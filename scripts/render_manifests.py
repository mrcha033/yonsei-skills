...
SPECS = {
    ...
    "yonsei-certificate-assistant": {
        ...
        "description": "macOS에서 증명서 선택부터 ReportX 인계, 문서번호 1회 예약, 호환 PDF 확인과 선택적 인쇄까지 진행합니다.",
        "short": "증명서 선택부터 PDF 확인까지 진행",
        "long": "공식 무료 프린터 출력 화면에서 학생이 선택한 증명서를 받아 검증된 런타임 자산과 독립 FP3 렌더러로 호환 PDF를 만듭니다. 발급 직전 확인과 문서번호 1회 예약 보호를 적용하며 공식 전자원본으로 주장하지 않습니다.",
    ...
    "yonsei-shuttle-booking": {
        "version": "0.3.0",
        "display": "연세 셔틀 조회·예약",
        "description": "방향·날짜·시간을 말하면 공식 셔틀 후보를 찾고, 선택한 편을 확인받아 예약·대기·취소합니다.",
        "short": "신촌·국제캠퍼스 셔틀 조회와 예약",
        "long": "기존 연세 로그인 세션으로 공식 셔틀 화면을 열어 조건에 맞는 편을 정리합니다. 정확한 차량과 시간을 다시 확인한 뒤 한 번만 예약·대기·취소하고 공식 내역에서 결과를 검증합니다.",
    ...
    "yonsei-space-reservation": {
        "version": "0.3.0",
        "display": "연세 공간 검색·신청",
        "description": "시간·인원·목적·장비 조건으로 공식 공간을 찾고, 검토한 대관 신청을 확인받아 제출합니다.",
        "short": "공간 후보 확인부터 대관 신청까지",
        "long": "공식 공간대관 화면에서 조건에 맞는 방을 찾고 공개 규칙, 수용인원, 시간과 표시 요금을 확인합니다. 최종 내용과 연락처를 보여 준 뒤 한 번만 제출하고 신청 내역에서 접수 상태를 검증합니다.",
