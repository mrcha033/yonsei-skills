# Certificate result boundary

The official free-print site prepares the student's authorized certificate and
hands a ReportX ticket to a local print component. The compatibility agent
accepts that ticket, retrieves only the prepared report authorized by it,
